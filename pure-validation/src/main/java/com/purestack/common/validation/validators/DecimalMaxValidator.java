 ...
 *
 */
public class DecimalMaxValidator implements IValidator {
	private static final Logger logger = Logger.getLogger(DecimalMaxValidator.class);
...
//			logger.warn("BigDecimal v1 , "+v1);
//			logger.warn("BigDecimal v2 , "+v2);
//			logger.warn("inclusive  , "+inclusive);
//			logger.warn("inclusiveVal  , "+inclusiveVal);
//			logger.warn("int r =v1.compareTo(v2)  , "+r);
